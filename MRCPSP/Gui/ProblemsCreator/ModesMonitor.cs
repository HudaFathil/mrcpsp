...
{
    class ModesMonitor : Form, ResourceObserver
    {
        ...
        private NumericUpDown m_mode_to_remove_sb;
        ...
        private void InitializeComponent()
        {
            ...
            this.m_mode_to_remove_sb = new System.Windows.Forms.NumericUpDown();
            ...
            ((System.ComponentModel.ISupportInitialize)(this.m_mode_to_remove_sb)).BeginInit();
            ...
            this.m_center_panel.Size = new System.Drawing.Size(464, 193);
            ...
            this.panel1.Size = new System.Drawing.Size(464, 189);
            this.panel1.TabIndex = 6;
            // 
            // groupBox2
            // 
            this.groupBox2.Controls.Add(this.m_mode_to_remove_sb);
            ...
            // m_mode_to_remove_sb
            // 
            this.m_mode_to_remove_sb.Location = new System.Drawing.Point(122, 56);
            this.m_mode_to_remove_sb.Name = "m_mode_to_remove_sb";
            this.m_mode_to_remove_sb.Size = new System.Drawing.Size(56, 20);
            this.m_mode_to_remove_sb.TabIndex = 7;
            // 
            ...
            this.m_remove_mode_button.Click += new System.EventHandler(this.m_remove_mode_button_Click);
            // 
            // splitContainer1
            // 
            ...
            // 
            this.splitContainer1.Panel1.Controls.Add(this.m_center_panel);
            // 
            // splitContainer1.Panel2
            // 
            this.splitContainer1.Panel2.Controls.Add(this.panel1);
            this.splitContainer1.Size = new System.Drawing.Size(464, 386);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.m_mode_to_remove_sb)).EndInit();
        ...
        private void m_add_operation_button_Click(object sender, EventArgs e)
        {
            ...
            data.Rows.Add(val);
            ((ResourceBase)m_resource_name_cb.SelectedItem).sign(this);
        }
        ...
        private void m_remove_mode_button_Click(object sender, EventArgs e)
        {
            int mode_id = (int)m_mode_to_remove_sb.Value;
            removeMode(mode_id);
        }

        private void removeMode(int id)
        {
            if (m_modes_index_to_table.ContainsKey(id))
            {
                m_modes_index_to_table[id].Parent.Dispose();
                m_modes_index_to_table.Remove(id);
            }
        }

        private bool gridContainsResource(DataGridView grid, ResourceBase r)
        {
            for (int i = 0; i < grid.RowCount; i++)
            {
                if (grid[0, i] != null && grid[0,i].Value ==r)
                    return true;
            }
            return false;
        }
        ...
        public void resourceDeleteNotify(ResourceBase r)
        {
            ...
            foreach (int key in m_modes_index_to_table.Keys)
            {
                if (gridContainsResource(m_modes_index_to_table[key], r))
                    toRemove.Add(key);   
            }
